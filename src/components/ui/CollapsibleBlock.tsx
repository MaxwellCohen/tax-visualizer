  ...
  return (
    <>
      <div class="flex items-center gap-3">
        <button
          type="button"
          class="grid h-9 w-9 shrink-0 place-items-center rounded-lg border border-border bg-surface-alt text-muted-foreground transition-[color,background-color,transform] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          aria-expanded={open()}
        ...
        <div class="flex min-w-0 flex-1 flex-wrap items-center justify-between gap-3">
          <h2
            id={titleId}
            class="text-sm font-semibold uppercase tracking-[0.12em] text-faint-foreground font-heading"
          >
            {props.title}
          </h2>
          {props.headerAside}
