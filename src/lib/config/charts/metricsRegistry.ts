 ...
 * summary hints, and serialization order. Registry data lives in {@link getConfigItems} from `taxPage.config.ts`.
 *
...
import { getConfigItems } from "../taxPage/taxPage.config";
import type { ConfigItem } from "../taxPage/types";
import { asSummaryChartRole, type SummaryChartRole } from "../taxPage/chart/chartRole";
